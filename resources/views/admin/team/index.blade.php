            ...
            <div class="box-body">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><img style="width: 120px;height:auto;" src="/uploads/team/{{$ban->image}}" alt=""></td>

                              <td>
                                          <form action="{{action('teamController@destroy',$ban->id)}}" method="post">
                                            {{csrf_field()}}
...
<div class="form-popup" id="myForm">
  <form action="{{ url('course') }}" method="post"   enctype="multipart/form-data" class="form-container">
    {{csrf_field()}}
    <h1>Add Product</h1>

    <label for="email"><b>Product</b></label>
    <input type="text" placeholder="Enter Product Name" name="name" required>
    {{-- <label for="email"><b>About Course</b></label>
