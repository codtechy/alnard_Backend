 ...
 <section class="content">
          ...
          <div class="box">
            ...
            <table class="table table-bordered">
                ...
                <th>Image</th>
                 ...
                 @foreach($images as $ban)
                <tr>
    

                  <td><img style="width: 120px;height:120px ;" src="/uploads/services/{{$ban->image}}" alt=""></td>




                              <td>
                                          <form action="{{action('serviceimagesController@destroy',$ban->id)}}" method="post">
                                            {{csrf_field()}}
  ...
  @else
        ...
        @endif
          ...
          <!-- /.box -->
          <button class="open-button" ><a style="color: white"  href="/serviceimages/create/">Add New Pics</a></button>
