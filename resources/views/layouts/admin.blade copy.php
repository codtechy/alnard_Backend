...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="header"><a href="/home">MAIN DASHBOARD</a></li>
         ...
         <!-- <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="/service/"><i class="fa fa-circle-o"></i>Service </a></li>
              <li><a href="/service/create/"><i class="fa fa-circle-o"></i>Add Service </a></li>
        ...
        {{-- <li><a href="/enquiry"><i class="fa fa-circle-o"></i> Enquiries</a></li> --}}
  ...
  <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/offer/create/"><i class="fa fa-circle-o"></i>Add image </a></li>
            <li><a href="/offer/"><i class="fa fa-circle-o"></i>Images </a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a target="_blank"  href="https://risbuzz.com/">Me</a>.</strong> All rights
    reserved.
  </footer>
...
{{-- <script src="{{ URL::asset('users/dist/js/pages/dashboard.js') }}"></script> --}}
