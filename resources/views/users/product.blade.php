                    ...
                    @else
                        <div class="page-header-box">
                            ...
                            <nav class="wow fadeInUp">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/">home</a></li>
                                    <li class="breadcrumb-item active" style="color: white" aria-current="page">our Products
                                    </li>
                                </ol>
                            </nav>
                        </div>
    ...
    <style>
        ...
        @media (max-width: 1200px) {
            .team-categories ul li {
                ...
                /* 4 items per row on larger tablets */
        ...
        @media (max-width: 768px) {
            .team-categories ul li {
                ...
                /* 2 items per row on mobile (2 columns) */
                ...
                @if ($products->isEmpty())
                    <div class="d-flex justify-content-center align-items-center" style="height: 50vh;">
                        <div class="text-center">
                            {{-- Uncomment the line below if you have an image for no products --}}
                            {{-- <img src="{{ asset('images/no-products.png') }}" alt="No Products" width="150"> --}}
                            <h4 class="text-danger mt-3">No Products Available Now</h4>
